...
public class DateTimePickerFragment extends DialogFragment
  ...
  private OnChangeListner listener = null;
  ...
  public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
    ...
    if (mode == Mode.DATE) {
      dialog = new DatePickerDialog(getActivity(), this,
          defaultValue.get(Calendar.YEAR), defaultValue.get(Calendar.MONTH),
          defaultValue.get(Calendar.DAY_OF_MONTH));
    } else {
      dialog = new TimePickerDialog(getActivity(), this,
          defaultValue.get(Calendar.HOUR_OF_DAY), defaultValue.get(Calendar.MINUTE),
  ...
  public OnChangeListner getListner() {
    return listener;
  }

  public void setListner(OnChangeListner listner) {
